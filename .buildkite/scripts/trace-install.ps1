...
# Instrumented step
C:\buildevents\buildevents.exe cmd $env:BUILDKITE_BUILD_ID $env:STEP_SPAN_ID npm-install -- cmd /c "cd C:\buildkite-agent\builds\Agent1\larchi\starter && npm install"
